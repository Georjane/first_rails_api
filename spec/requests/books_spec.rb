...
RSpec.describe 'Books API', type: :request do
  ...
  let!(:books) { create_list(:todo, 10) }
  let(:todo_id) { books.first.id }
  ...
  describe 'PUT /books/:id' do
    ...
    context 'when the record exists' do
      before { put "/books/#{todo_id}", params: valid_attributes }
